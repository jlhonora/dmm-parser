...
num_dict = {0: ' ', 0x68: 'L', 0x7D: 0, 0x05: 1, 0x5B: 2,
            0x1F: 3, 0x27: 4, 0x3E: 5, 0x7E: 6, 0x15: 7, 0x7F: 8, 0x3F: 9}
...
def parse_data(line):
    try:
        ...
        if ms_dict[2][3]:
            num_str = num_str + '-'
        num_str = num_str + str(num_dict[ba2int(first_ba)])
        if ms_dict[4][3] == True:
            num_str = num_str + "."
        num_str = num_str + str(num_dict[ba2int(second_ba)])
        if ms_dict[6][3] == True:
            num_str = num_str + "."
        num_str = num_str + str(num_dict[ba2int(third_ba)])
        if ms_dict[8][3] == True:
            num_str = num_str + "."
        num_str = num_str + str(num_dict[ba2int(fourth_ba)])
